...
Status: prepared locally; production verification follows release. Previous verified baseline: `463cbd8ebb980a6416ceff0866a2272f55a8e9d6` (website implementation `5f4f9e5`). Active source remains `.worktrees/company-update`; the root broad rebuild stays parked.
